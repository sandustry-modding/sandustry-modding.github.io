window.SMT_SEARCH_INDEX = [
  ...
  {
    "title": "OKF bundle",
    "body": "Open Knowledge Format markdown bundle for agents. Start at llms.txt, then Consume. For the domain index, see OKF index.",
    "path": "/okf/README",
    "id": ""
  },
  {
