...
| `config`                  | reader arity **2** + `getLegacy` / `set` — see [Engine config and extend](/okf/internals/engine-config.md)                                                                                                                                   |
...
| `extend`                  | arity **3** `(state, namespace, impl)` — see [Engine config and extend](/okf/internals/engine-config.md)                                                                                                                                     |
| `extensions`              | define                                                                                                                                                                                                                                      |
